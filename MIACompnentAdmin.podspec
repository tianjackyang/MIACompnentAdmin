#
#  Be sure to run `pod spec lint MIACompnent.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/tianjackyang/MIACompnentAdmin.git", :tag => s.version.to_s }
